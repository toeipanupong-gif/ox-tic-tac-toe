...
- ผู้เล่น vs Bot 3 ระดับ: Easy (สุ่มทุกตา) / Normal (ชนะทันทีถ้าได้ + บล็อกเสมอเมื่อถูกขู่ นอกนั้นพลาดบ่อย) / Hard (ชนะทันทีถ้าได้ + บล็อกเสมอ นอกนั้นเล่นใกล้เคียง Minimax เต็มรูปแบบ พลาดน้อย)
